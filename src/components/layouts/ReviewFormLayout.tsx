...
export const ReviewFormLayout = ({
  ...
  return (
    <div>
      ...
      <div className="grid p-4 lg:gap-14 lg:px-14 lg:pb-14 lg:grid-rows-1 lg:grid-cols-[3fr_6fr_3fr]">
        ...
        <div className="lg:order-3">
          ...
          {(comment || commentTitle) && (
            <Comment className="mb-8" image={image} imageAlt={imageAlt} comment={comment} commentTitle={commentTitle} />
          )}
        </div>
        ...
        <div className="lg:order-2">
          ...
          <div className="mt-6 lg:w-100 lg:p-8 lg:bg-white lg:rounded-2xl lg:my-4">{children}</div>
        </div>
      </div>
    </div>
  )
