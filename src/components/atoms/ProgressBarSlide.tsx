...
type DataProgressType = {
  data: any[] //pongo any porque literalmente puede ser cualquier cosa, realmente no nos hace falta los datos en si, si no el array para poder trabajar con sus poiciones
  currentDataIndex: number
  setCurrentDataIndex: React.Dispatch<React.SetStateAction<number>>
}

export const ProgressBarSlide = ({ data, currentDataIndex, setCurrentDataIndex }: DataProgressType) => {
